      ...
      <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-6">
          ...
          <p class="mt-1 text-sm/6 text-gray-600">
            Ovdje možete dodati i izmijeniti svoje podatke. Podaci se koriste za informacije o
            dostavi.
          </p>
        </div>
        ...
        <div class="border-b border-gray-900/10 pb-12">
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div class="col-span-full">
              <label for="slikaProfila" class="block text-sm/6 font-medium text-gray-900"
                >Slika profila</label
              >
              <div class="mt-2 flex items-center gap-x-3">
                <img
                  class="mr-1 w-20 h-20 object-cover rounded-full"
                ...
                <button
                  type="button"
                  class="rounded-md bg-white px-2.5 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50"
                >
                  Promjeni
                </button>
              </div>
