...
const detalji = computed(() => napravljene_narudzbe.detalji)
...
onMounted(async () => {
  const narudzba_id = Number(route.params.narudzbaId)
  await napravljene_narudzbe.ucitajDetaljeNarudzbe(narudzba_id)
})
</script>
