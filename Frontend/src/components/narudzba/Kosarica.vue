    ...
    >
      <div class="mx-auto max-w-3xl">
        ...
        <div class="mt-8">
          ...
          <div class="mt-8 flex justify-end border-t border-[#223c2f] pt-8">
            <div class="w-screen max-w-lg space-y-4">
              ...
              <div class="flex justify-end">
                <router-link
                  ...
                  class="block rounded-sm bg-teal-600 px-5 py-3 text-sm text-gray-100 transition hover:bg-gray-600"
                >
